  ...
  return (
    <Stack gap="60px" sx={{flexDirection: {lg:"row"},p:"20px",alignItems:"center"}}>
      ...
      <Stack sx={{gap:{lg:"35px",xs:"20px"}}}>
        ...
        <Typography variant="h6">Exercises keep you strong. <span style={{fontWeight:"bold"}}>{name} </span>is one of the best
exercises to target your <span style={{fontWeight:"bold"}}>{target} </span>. It will help you improve your
posture and gain strength.</Typography>
{
