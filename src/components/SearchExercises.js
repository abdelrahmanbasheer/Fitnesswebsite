  ...
  return (
   <Stack
    ...
    <Typography fontWeight="700" sx={{fontSize: {lg:"44px",xs:"30px"}}} mb="50px" textAlign="center">
      Awesome Exercises <br></br> You Should Know
    </Typography>
    <Box position="relative" mb="72px" mr="150px" >
      ...
      sx={{bgcolor:"#1D44C2",color:"white",
      textTransform:"none", width:{lg:"170px",xs:"80px"},
    ...
    <Box sx={{postion:"relative",width:"100%" ,padding:"20px"}}>
